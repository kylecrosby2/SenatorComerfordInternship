#! python3
# CommunityFluencyAutomation2.py - More efficient way to log contacts to CF.
...
class Stopper:
    ...
    def __init__(self, start_next_email):
        self.start_next_email = start_next_email
...
def main():
    user_input = input('On behalf? (yes/no): ')
    on_behalf = False
    ...
    legislation_groups = ['"Person with a disability" (S.2554)', '100% Renewable Energy (H2836/S1985)',
                          'Alternative Health Care (S.2634, S.665, H.3660)',
                          'Animal Research bills (S.534, H.758, H.764)', 'Au pair bills (H.4705, H.4707)',
                          'Ban Facial Recognition (S.1385/H.1538)', 'Ban Flavored Tobacco (H.4089/S.2357)',
                          'Ban Glyphosate bill (H.792)', 'Bodyworks bill (S.168)', 'Breakfast After the Bell (S.267)',
                          'Breakfast after the Bell (H.4218)', 'Carbon pricing (H.2810)',
                          'Cats & Dogs Retail Sale Ban bills (S.175/H.800)',
                          'Central Service Technicians (S2447/H4267)', 'Change the State Flag and Seal (S.1877/H.2776)',
                          'Civil service exams (H.2292)', 'Construction Defect Claims Condo Owners (H4605)',
                          'Dark Sky bill (H.2858/S.1937)', 'Decarceration and COVID-19 (H.4652)',
                          'Distracted Driving bill', 'Economic Development Bond Bill (S.2842, H.4879)',
                          'Election Day Registration (S.396, H.685, H.636)', 'Emergency Paid Sick Time (S.2701/H.4700)',
                          'Emergency housing bills (S.2831/H.4878)', 'End of Life Options',
                          'Environmental Justice (H4264/S453/S464)', 'Equality & Respect in the Leg (S.1898, H.3572)',
                          'FY21 Budget: Pollinator habitats', 'Factory Worker Protection - COVID19 (SD.2934/H.4738)',
                          'Fairness in Debt Collection (H.4694/S.2734)', 'Family caregiver tax credit (S.702/H.2608)',
                          'Farmer overtime (S.2347)', 'Female Genital Mutilation (H4606)',
                          'Film/TV incentive bills (H.2419/S.1728)', 'Flame Retardant Protection (S.1230/S.2338)',
                          'Free Phone Calls for Incarcerated People (S.2846)', 'Genocide Education (S2581)',
                          'Gun Crime Data (H.2405/S.1388)',
                          'Hazard Pay for Essential Workers/Public Employees (H.4631, HD.5031)', 'Healthy Soils',
                          'Healthy Youth Act (S. 2459)', 'Homeless families & youth state ID (S.2555)',
                          'Host Community Agreement bills', 'IT Bond Bill 2020 (H.4708/H.4733/S.2759)',
                          'Incarcerated people protection (S.1372, S.2662, S.1391/H.2127, H.4607)',
                          "Indigenous Peoples' bills", 'Juneteenth Holiday (SD2975/HD5141)',
                          'Life Without Parole (S.826/H.3358)', 'MCAS COVID moratorium (SD.2986)',
                          'MassHealth estate recovery (SD.2976/HD.5144)', 'Mosquito/arbovirus (H.4650)',
                          'Net Metering Exemption for Solar Energy Generation (H2866)',
                          'Net Zero Emissions by 2050 (H3983)', 'Net Zero Stretch Energy Code',
                          'Nurse Licensure Compact (H.1944/S.103)',
                          'Nurse Practitioner full practice authority (S.1330, H.1867)',
                          'Nurse w/out Supervising MD (S.1157)',
                          'Out of hospital birth access and safety/midwives (S2863)', 'POST (H.2146)',
                          'Parents Running for Office (S.408)', 'Pesticides & School Children bill (H.791)',
                          'Plastic Bag Bill', 'Police Reform (S.2800, S.2820)', 'Pollinators (S.447/H.776, H.763)',
                          'Post Election Audit bills (S.388, H.694, H.687, H.721)',
                          'Prevent Death and Disability from Stroke (S2835)', 'Prevent Nuclear Weapons Use (S.2165)',
                          'Prevent Overdose Deaths, Increase Access to Treatment (H.1712/S.2717)',
                          'Prohibit Native American Mascots (S.247/H.443)',
                          'Protect Animals from Abusers bill (H.3772/S.2494)', 'Putting patients first (S.2769)',
                          'ROE Act (S. 1209)', 'Recess (S.330/H.426)', 'Recycling (H.2837/S.1939)',
                          'Recycling nips (H.2881/S.452)',
                          'Reduce racial disparities in maternal health (S.2697/H.4448)', 'Right to Repair bills',
                          'Right to counsel (S.913/H.3456 & H.1537)', 'SAVE Act NPs (H.1867/S.1330)',
                          'SAVE Students (S.285)', 'Safe Communities Act (S.1401)',
                          'Safe Drinking Water in Schools (S2503)', 'Safe Injection/Consumption Sites (H4723)',
                          'Sample bill (H.123)', 'Saving black lives and transforming public safety (HD5128/SD2968)',
                          'Secure civil rights through the courts of the Commonwealth (H3277)',
                          'Senate climate bills (S.2476, S.2477, S.2478)',
                          'Sewage Pollution in Public Waters (H4921/S490)', 'Sexual Assault on Campuses bills',
                          'Sexual harassment policy bills (S.929)', 'Social Equity Fund in CCC (S2650)',
                          'Spouses as caregivers (S.28)', 'Structural racism commission (H.1440)',
                          'Student Opportunity Act', 'TAFDC and EAEDC Emergency Payments (H.4622)',
                          'Traffic enforcement cameras (S.2553)', 'Transfer Tax (H.1769)',
                          'Transportation Revenue bills (H.4506, H.4508)', 'Transportation bond bill (S.1813)',
                          'Traveling Exhibit Animal bills', 'Universities & medicated abortion (H.3841)',
                          'Vaccine Community Immunity bills (S.2359, H.4096)', 'Vaccine HPV bill (S.1264)',
                          'Vaccine Religious Exemption bill (H.3999)', 'Vaccine bill H.1848',
                          'Voting by Mail and Early Voting in 2020 (S.2654/HD.5026, S.2653, S.2608, H.4737)',
                          'Wendell Forest bill (H.897)', 'Work & Family Mobility Act']
    issue_groups = ['ROE Act in FY21 Budget', 'Legalize Sports Betting', '5G Technology', 'Agriculture, Farms & Farmers', 'Animal Rights', 'Arts & Culture',
                    'Ban Solitary Confinement', 'Broadband connectivity',
                    'COVID-19: Public Education Funding',
                     'Civil & Human Rights',
                    'Close Corporate Tax Loopholes', 'Convention Of States', 'Criminal Justice Reform',
                    'Democracy & Transparency', 'Disability Rights', 'Divest state pension funds from fossil fuels',
                    'EEE', 'East Northfield Water Company', 'Education (Higher Ed)',
                    'Elders', 'Elections/Voting',
                    'Electric School Buses', 'Energy & Environment',
                    'FY20 Supplemental Budget: TAFDC and EAEDC Short Term Relief', 'FY21 Budget',
                    'FY21 DDS funding for day/work programs',
                    'Fair Share Amendment', 'Farmers OT (overtime)', 'Farren Care Center closure', 'Firearm safety',
                    'Fix charter school funding', 'Food Security', 'Foster Care', 'General Pierce Bridge',
                    'Greenfield RMV', 'Gun Safety', 'Harm Reduction', 'Health Care', 'Hemp',
                    "Holyoke Soldiers' Home funding", 'Housing', 'Immigrant rights', 'Indigenous Peoples', 'Lake Wyola',
                    'Libraries', 'Lower Flags for International Overdose Awareness Day', 'MRF Contract',
                    'Medicare For All', 'Mental Health', 'Municipal Power Aggregation',
                    'National Guard activated by Governor', 'National Popular Vote', 'Neonicotinoids Ban',
                    'Net neutrality', 'Northampton artifacts/MassDOT project', 'Orange Schools Funding Cuts',
                    'PACE (Program of All-inclusive Care for the Elderly)', 'Pesticide Use', 'Police reform',
                    'Polystyrene Ban', 'Prop. 2 1/2', 'Public Health', 'Rail', 'Ranked Choice Voting',
                    'Real time sales tax', 'Regional & Economic Development', 'Reparations', 'Revenue',
                    'SEVP changes & international students', 'SMART Program (Solar)', 'Save Wendell State Forest',
                    'Socially Responsible State Investing', 'Solar', 'Souza Baranowski Correctional Center',
                    'State Mandated Flu Vaccine for Students', 'Statewide Popular Vote for President',
                    'Synthetic Nitrogen Fertilizers', 'TCI - Transportation Climate Initiative', 'Test 3',
                    'Transportation', 'Trash and Recycling Reform', 'UMass', 'Vaping & Tobacco', 'Vaping Ban',
                    'Veterans', "Women's Health", 'Level Funding for Public Higher Ed FY21']
    skipped_file = open('SkippedEmailListFile.txt', 'a', encoding='utf-8')
    stopper_object = Stopper(True)
    while True:
        email = ''
        try:
            thread_input = input('Copy the email thread then press Enter. If you are done with the threads, type Done.: ')
            t = thread_input.lower()
            if t != 'done':
                ...
                for i in range(1, len(individual_emails)):
                    email = individual_emails[i]
                    email_object = Email('', '', [], [], '', '', [], '')
                    get_groups(legislation_groups, issue_groups, email_object, individual_emails)
                    get_constituent_name(email, email_object, on_behalf)
                    email_object.email_text = email
                    email_object.email_phone_list = find_emails_and_phone_numbers(email, short_day_list, short_month_list)
                    email_object.pronouns = pronoun_search(email, short_day_list, short_month_list)
                    get_date(email, short_day_list, short_month_list, email_object)
                    email_object.email_type = determine_email_type(email, short_day_list, short_month_list)
                    skip = check_info(email_object, individual_emails)
                    if skip is True:
                        add_to_file(skipped_file, email)
                    else:
                        email_list.append(email_object)
            else:
                break
        except Exception as exc:
            print('Error: %s. Email will be added to skipped file.' % exc)
            add_to_file(skipped_file, email)
            continue
    skipped_file.close()
    skipped_file = open('SkippedEmailListFile.txt', 'a', encoding='utf-8')
    logged_file = open('LoggedEmailListFile.txt', 'a', encoding='utf-8')
    ...
    for email_object in email_list:
        #stopper_object.start_next_email = False
        try:
            name_elem_num = input_to_cf_log(email_object, driver)
            quick_edit_profile(driver2, driver3, email_object, name_elem_num, stopper_object)
            add_to_file(logged_file, email_object.email_text)
        except Exception as exc:
            print('Error: %s' % exc)
            print('Email will be skipped.')
            add_to_file(skipped_file, email)
            continue
        time.sleep(12)
    skipped_file.close()
...
def get_groups(legislation_groups, issue_groups, thread_object, individual_emails):
    ...
    positions_list = ['Supports', 'Concerned', 'Undecided', 'Opposed', 'Opposes']
    position = '(Position)'
...
def get_constituent_name(email, thread_object, on_behalf):
    name = ''
    if on_behalf is False:
        ...
        for line in email.split('\n'):
            if line[:5] == 'From:':
                ...
                print(line_list)
                name += '%s %s' % (str(line_list[-2]), str(line_list[-1][:-1]))
        thread_object.constituent_name = name.strip()


# Function that uses regular expressions to find emails and phone numbers in the constituent emails to add to
# their files.
def find_emails_and_phone_numbers(email, short_day_list, short_month_list):
    ...
    if email_type == 'Email Received From Constituent':
        ...
        for groups in phone_regex.findall(email):
            ...
            if phone_num != '-020-2021':
                phone_num_list.append(phone_num)
    email_list2 = []
    for i in email_list:
        if i == 'info@email.actionnetwork.org' or 'masenate' in i or 'oneclickpolitics' in i:
            continue
        if list(i)[0] == '<':
...
def pronoun_search(email, short_day_list, short_month_list):
...
def check_info(thread_object, individual_emails):
    ...
    position = '(Position)'
    new_email_list = []
    for i in thread_object.email_phone_list[0]:
        if 'info@email.actionnetwork.org' in i or 'masenate' in i:
            continue
        else:
            new_email_list.append(i)
    thread_object.email_phone_list[0] = new_email_list
    while True:
        ...
        if user_input.lower() == 's':
            skip = True
            print('Email has been skipped. It has been added to a text file with all skipped emails to add manually'
                  'later.')
            break
    return skip


def add_to_file(file, email):
    file.write('\n\n\nNEW EMAIL:\n')
    file.write(email)
...
def input_to_cf_log(thread_object, driver):
    email = thread_object.email_text
    name = thread_object.constituent_name
    time.sleep(5)
    #driver.find_element_by_id('call-log-notes').send_keys('Hello There!')
...
def quick_edit_profile(driver2, driver3, thread_object, name_elem_num, stopper_object):
    if __name__ == '__main__':
        Thread(target=add_to_groups, args=[driver3, thread_object, name_elem_num, stopper_object]).start()
